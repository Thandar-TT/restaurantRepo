					...
					<form class="booking-form" id="myForm" action="">
						<div class="row">
							<div class="col-lg-12 d-flex flex-column mb-20">
								<input name="Report-name" placeholder="Report Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Report Name'"
								 class="form-control" required="" type="text">
							</div>

							<div class="input-group col-lg-6 mb-20">
								<input id="event_date" class="form-control datepicker" placeholder="Report Date" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = 'Report Date'" class="form-control" required="" type="text">
							</div>

							<div class="col-lg-6 d-flex flex-column mb-20">
								<input id="comid" class="form-control datepicker" placeholder="Composer ID" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = 'Composer ID'" class="form-control" required="" type="text">
							</div>

							<div class="col-lg-6 d-flex flex-column mb-20">
								<input id="comid" class="form-control datepicker" placeholder="Report type" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = 'Report type'" class="form-control" required="" type="text">
							</div>
							<div class="col-lg-6 d-flex flex-column mb-20">
								<input name="budget" placeholder="Month" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Month'"
								 class="form-control" required="" type="text">
							</div>
							<div class="col-lg-12 d-flex flex-column">
								<textarea class="form-control" name="post-message" placeholder="Type Report here" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = 'Type report here'" required=""></textarea>
							</div>
