		...
		<div class="container">
			<div class="row height align-items-center justify-content-center">
				<div class="banner-content col-lg-5">
					<h1>See all reservations</h1>
					<hr>
					<div class="breadcrmb">
						<p>
							<a href="welcome.php">Staff</a>
							<span class="lnr lnr-arrow-right"></span>
							<a href="allRes.php">All reservations</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row align-items-center">
				<div class="col-lg-5 col-md-5">
					<div class="section-title relative">
						...
						<p>See all bookings or reservations in the database that Customers made</p>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["eventName"] . "</td><td>". $row["eventdate"]."</td><td>".$row["eventName"]."</td><td>".$row["eventdate"]."</td><td>".$row["eventdate"]."</td></tr>";
    }
} else {
    echo "0 results";
}
