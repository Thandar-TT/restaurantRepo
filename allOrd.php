				...
				<div class="banner-content col-lg-5">
					...
					<div class="breadcrmb">
						<p>
							...
							<a href="allOrd.php">All orders</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row align-items-center">
				<div class="col-lg-5 col-md-5">
					<div class="section-title relative">
						...
						<p>See all details of orders in the database that Customers place</p>
                	...
                	<div class="col-lg-6 d-flex flex-column mb-20">
								<div class="nice-select app-select form-control " tabindex="0">
									...
									<ul class="list">
										...
										<li data-value="2" class="option">Address</li>
										<li data-value="3" class="option">Menu Item</li>
									</ul>
								</div>
							</div>
